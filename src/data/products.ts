...
export const categories: Category[] = [
  { id: "cat-soap", name: "জৈব সাবান", slug: "soap", image: categorySoap, description: "প্রাকৃতিক ও হাতে তৈরি সাবান", count: 7 },
  { id: "cat-oil", name: "প্রাকৃতিক তেল", slug: "oil", image: categoryOils, description: "বিশুদ্ধ ও কোল্ড-প্রেসড তেল", count: 6 },
  { id: "cat-skincare", name: "ভেষজ স্কিনকেয়ার", slug: "skincare", image: categorySkincare, description: "ত্বকের যত্নে প্রকৃতির ছোঁয়া", count: 7 },
  { id: "cat-food", name: "স্বাস্থ্যকর খাবার", slug: "food", image: categoryFood, description: "খাঁটি ও জৈব খাদ্য সামগ্রী", count: 7 },
];

...
const defaultReviews = [
  { name: "সারাহ মুন্নি", text: "হার্বাল হোমসের ল্যাভেন্ডার সাবান ৩ মাস ধরে ব্যবহার করছি। আমার ত্বক এত ভালো আগে কখনো ছিল না!", rating: 5 },
  { name: "জামিল রহমান", text: "কালোজিরার তেলের মান অসাধারণ। কোল্ড-প্রেসড এবং বিশুদ্ধ — বাজারের অন্যান্য ব্র্যান্ডের সাথে পার্থক্যটা স্পষ্ট।", rating: 5 },
  { name: "আমিরা খান", text: "চমৎকার প্যাকেজিং, অসাধারণ পণ্য। রোজহিপ সিরাম আমার স্কিনকেয়ার রুটিন বদলে দিয়েছে!", rating: 5 },
];

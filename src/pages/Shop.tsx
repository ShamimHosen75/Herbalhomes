    ...
    <PageLayout>
      <section className="bg-accent py-8 md:py-10">
        <div className="container mx-auto px-4">
          <Breadcrumb items={[{ label: "পণ্য সমূহ" }]} />
          <h1 className="text-2xl md:text-3xl font-bold text-foreground mt-3">সকল পণ্য</h1>
          <p className="text-muted-foreground mt-1">আমাদের সকল জৈব ও প্রাকৃতিক পণ্যের সংগ্রহ</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-3 mb-6">
            <div className="relative flex-1">
              ...
              <input type="text" placeholder="পণ্য খুঁজুন..." value={search} onChange={(e) => { setSearch(e.target.value); setPage(1); }} className="w-full h-11 pl-10 pr-4 rounded-xl bg-muted border-0 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30" />
          ...
          {showFilters && (
            <div className="bg-card rounded-2xl border border-border p-5 mb-6 animate-fade-in">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <h4 className="text-sm font-semibold text-foreground mb-3">মূল্য পরিসীমা</h4>
                ...
                <div>
                  <h4 className="text-sm font-semibold text-foreground mb-3">উপলভ্যতা</h4>
          ...
          {paginatedProducts.length > 0 ? (
            ...
            <div className="text-center py-16">
              <p className="text-lg font-semibold text-foreground mb-2">কোনো পণ্য পাওয়া যায়নি</p>
              <p className="text-sm text-muted-foreground">অনুগ্রহ করে অন্য কিছু খুঁজুন অথবা ফিল্টার পরিবর্তন করুন।</p>
            </div>
          )}
